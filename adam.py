...
def test_linear():
    ...
    # assert that state_dict is similar for exp_avg and exp_avg_sq
    assert(torch.allclose(adam.state_dict()['state'][0]['exp_avg'], fused_adam.state_dict()['state'][0]['exp_avg']))
    # assert(torch.allclose(adam.state_dict()['state'][0]['exp_avg_sq'], fused_adam.state_dict()['state'][0]['exp_avg_sq']))
